...
public class DijkstraPaintPanel extends JPanel implements ActionListener{

	private DijkstraWindow window;
	
	private int sizeNode;
	
	public DijkstraPaintPanel(DijkstraWindow djWindow) {
		window = djWindow;
		sizeNode = 0;
...
//		System.out.println("paint");
		...
		Node<String, Star>[] path = window.getGui().getGraphAL().dijkstra("Sol", "YZ Ceti");
...
//		}
	...
	public void exeDijkstra() {
		...
		window.getGui().getGraphAL().dijkstra("Sol");
